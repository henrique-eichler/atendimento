    ...
    public void checkRunningEnvironment() {
        ...
        if (!isRunningInTestSuite) {
            ...
            if (!isRunningInTestSuite) {
                ...
                System.out.println("  mvn test -Dtest=com.clinica.atendimento.selenium.SeleniumTestSuite");
                System.out.println("  or");
                System.out.println("  java -cp <classpath> com.clinica.atendimento.selenium.SeleniumTestSuite");
                System.out.println("=================================================================");
