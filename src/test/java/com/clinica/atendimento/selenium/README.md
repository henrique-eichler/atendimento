...
```bash
# Run all tests
java -cp target/test-classes:target/classes:path/to/dependencies com.clinica.atendimento.selenium.RunSeleniumTests

# Run only ProfissionalCadastroTest
java -cp target/test-classes:target/classes:path/to/dependencies com.clinica.atendimento.selenium.RunSeleniumTests profissional

# Run only SalaCadastroTest
java -cp target/test-classes:target/classes:path/to/dependencies com.clinica.atendimento.selenium.RunSeleniumTests sala
```
...
```bash
mvn test -Dtest=com.clinica.atendimento.selenium.SeleniumTestSuite
```
...
```bash
# Run only ProfissionalCadastroTest
mvn test -Dtest=com.clinica.atendimento.selenium.SeleniumTestSuite -Dgroups=profissional

# Run only SalaCadastroTest
mvn test -Dtest=com.clinica.atendimento.selenium.SeleniumTestSuite -Dgroups=sala
```
