...
onMounted(() => {
  // Subscribe to topics
  subscriptions.push(
    WebSocketService.subscribe("/app/terapia/retorno/listar", msg => retornoListar(JSON.parse(msg.body)))
  )

  subscriptions.push(
    WebSocketService.subscribe("/app/terapia/retorno/salvar", msg => retornoSalvar(JSON.parse(msg.body)))
  )

  subscriptions.push(
    WebSocketService.subscribe("/app/terapia/retorno/editar", msg => retornoEditar(JSON.parse(msg.body)))
  )

  subscriptions.push(
    WebSocketService.subscribe("/app/terapia/retorno/excluir", msg => retornoExcluir(JSON.parse(msg.body)))
  )
