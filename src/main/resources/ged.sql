...
create table grupo (
    id bigint generated always as identity not null constraint pk_grupo primary key,
...
create table usuario (
    id bigint generated always as identity not null constraint pk_usuario primary key constraint fk_usuario_pessoa references pessoa,
    senha varchar(255) not null
);

create table recurso (
    id bigint generated always as identity not null constraint pk_recurso primary key,
...
create table grupo_recurso (
    id bigint generated always as identity not null constraint pk_grupo_recurso primary key,
...
create table grupo_usuario (
    id bigint generated always as identity not null constraint pk_grupo_usuario primary key,
...
create table gestao (
    id bigint generated always as identity not null constraint pk_gestao primary key,
...
create table tipo_documento (
    id bigint generated always as identity not null constraint pk_tipo_documento primary key,
    descricao varchar(255) not null,
    mimetype varchar(255) not null
);

create table documento (
    id bigint generated always as identity not null constraint pk_documento primary key,
...
create table gestao_documento (
    id bigint generated always as identity not null constraint pk_gestao_documento primary key,
